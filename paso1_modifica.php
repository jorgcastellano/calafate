...
echo "<form method='post' action='paso2_modifica.php?id=$_GET[id]$clave_vendedor' name='paso1'>";
...
include_once("calcula_precios_modifica.inc.php");
...
$busca_pan = mysql_query("select * from pasajeros where tipo_p = 'comprador' and idd_carga_p='$_GET[id_venta]' order by id_pasajero_p asc");
$cta_pan = mysql_num_rows($busca_pan);

for($h=1;$h<=$cta_pan;$h++){
$l_pan = mysql_fetch_assoc($busca_pan);
...
echo "<div class='titulo_form'>$codigo_ir[$o] : <span style='color:#ff0000;font-size:10px;text-transform:lowercase'>* dato obligatorio</span></div>
     <input type='text' name='a$o' id='a$o' value='$dy[$num_dato]'>
...
echo "<div class='titulo_form'>$codigo_ir[$o] : </div>
     <input type='text' name='a$o' value='$dy[$num_dato]' ><br>
	 ";
...
//busca total de campos de datos por pasajero

//$busca_pan_tot = mysql_query("select * from pasajeros where tipo_p = 'pasajero' and categoria_p='adulto' and idd_carga_p='$_GET[id_venta]' order by id_pasajero_p asc");

$busca_pan_tot = mysql_query("select * from pasajeros where tipo_p = 'pasajero' and idd_carga_p='$_GET[id_venta]' order by id_pasajero_p asc");



$cta_pan_tot = mysql_num_rows($busca_pan_tot);

//$toti_pan = $cta_pan_tot / $_POST["adulto_antes"];
$toti_pan = $cta_pan_tot / $suma_pasajeros_antes;

$toti_pan = ceil($toti_pan);



//fin busca total de campos de datos por pasajero
...
for($dc=1;$dc<=$vueltas_adulto;$dc++){



//datos adulto

$busca_pan = mysql_query("select * from pasajeros where tipo_p = 'pasajero' and categoria_p='adulto' and idd_carga_p='$_GET[id_venta]' order by id_pasajero_p asc limit $inc_vuelta,$toti_pan ");
$cta_pan = mysql_num_rows($busca_pan);
...
$inc_vuelta = $inc_vuelta + $toti_pan;
...
if(isset($dy[$num_dato])){
$f_dat = $dy[$num_dato];
}else{ //if(isset($dy[$num_dato])){
$f_dat = "";
} //if(isset($dy[$num_dato])){

echo "<div class='titulo_form'>$codigo_ir[$o] : <span style='color:#ff0000;font-size:10px;text-transform:lowercase'>* dato obligatorio</span></div>
     <input type='text' name='inv_adulto_$dc"."_".$o."' id='inv_adulto_$dc"."_".$o."' value='$f_dat'>
...
echo "<div class='titulo_form'>$codigo_ir[$o] : </div>
     <input type='text' name='inv_adulto_$dc"."_".$o."' value='$f_dat' ><br> ";
...
for($dc=1;$dc<=$vueltas_bebe;$dc++){

//datos bebe

$busca_pan = mysql_query("select * from pasajeros where tipo_p = 'pasajero' and categoria_p='bebe' and idd_carga_p='$_GET[id_venta]' order by id_pasajero_p asc limit $inc_vuelta,$toti_pan ");
$cta_pan = mysql_num_rows($busca_pan);
...
echo "<div class='titulo_form'>$codigo_ir[$o] : <span style='color:#ff0000;font-size:10px;text-transform:lowercase'>* dato obligatorio</span></div>
     <input type='text' name='inv_bebe_$dc"."_".$o."' id='inv_bebe_$dc"."_".$o."' value='$f_dat' >
...
echo "<div class='titulo_form'>$codigo_ir[$o] : </div>
     <input type='text' name='inv_bebe_$dc"."_".$o."' value='$f_dat' ><br> ";
...
for($dc=1;$dc<=$vueltas_menor1;$dc++){

//datos nino

$busca_pan = mysql_query("select * from pasajeros where tipo_p = 'pasajero' and categoria_p='nino' and idd_carga_p='$_GET[id_venta]' order by id_pasajero_p asc limit $inc_vuelta,$toti_pan ");
$cta_pan = mysql_num_rows($busca_pan);
...
echo "<div class='titulo_form'>$codigo_ir[$o] : <span style='color:#ff0000;font-size:10px;text-transform:lowercase'>* dato obligatorio</span></div>
     <input type='text' name='inv_nino_$dc"."_".$o."' id='inv_nino_$dc"."_".$o."' value='$f_dat' >
...
echo "<div class='titulo_form'>$codigo_ir[$o] : </div>
     <input type='text' name='inv_nino_$dc"."_".$o."' value='$f_dat' ><br> ";
...
for($dc=1;$dc<=$vueltas_menor2;$dc++){

//datos nino

$busca_pan = mysql_query("select * from pasajeros where tipo_p = 'pasajero' and categoria_p='nino1' and idd_carga_p='$_GET[id_venta]' order by id_pasajero_p asc limit $inc_vuelta,$toti_pan ");
$cta_pan = mysql_num_rows($busca_pan);
...
echo "<div class='titulo_form'>$codigo_ir[$o] : <span style='color:#ff0000;font-size:10px;text-transform:lowercase'>* dato obligatorio</span></div>
     <input type='text' name='inv_nino1_$dc"."_".$o."' id='inv_nino1_$dc"."_".$o."' value='$f_dat' >
...
echo "<div class='titulo_form'>$codigo_ir[$o] : </div>
     <input type='text' name='inv_nino1_$dc"."_".$o."' value='$f_dat'><br> ";
...
for($dc=1;$dc<=$vueltas_menor3;$dc++){

//datos nino 

$busca_pan = mysql_query("select * from pasajeros where tipo_p = 'pasajero' and categoria_p='nino2' and idd_carga_p='$_GET[id_venta]' order by id_pasajero_p asc limit $inc_vuelta,$toti_pan ");
$cta_pan = mysql_num_rows($busca_pan);
...
echo "<div class='titulo_form'>$codigo_ir[$o] : <span style='color:#ff0000;font-size:10px;text-transform:lowercase'>* dato obligatorio</span></div>
     <input type='text' name='inv_nino2_$dc"."_".$o."' id='inv_nino2_$dc"."_".$o."' value='$f_dat'>
...
echo "<div class='titulo_form'>$codigo_ir[$o] : </div>
     <input type='text' name='inv_nino2_$dc"."_".$o."' value='$f_dat' ><br> ";
...
for($dc=1;$dc<=$vueltas_senior;$dc++){


//datos senior

$busca_pan = mysql_query("select * from pasajeros where tipo_p = 'pasajero' and categoria_p='senior' and idd_carga_p='$_GET[id_venta]' order by id_pasajero_p asc limit $inc_vuelta,$toti_pan ");
$cta_pan = mysql_num_rows($busca_pan);
...
echo "<div class='titulo_form'>$codigo_ir[$o] : <span style='color:#ff0000;font-size:10px;text-transform:lowercase'>* dato obligatorio</span></div>
     <input type='text' name='inv_senior_$dc"."_".$o."' id='inv_senior_$dc"."_".$o."' value='$f_dat' >
...
echo "<div class='titulo_form'>$codigo_ir[$o] : </div>
     <input type='text' name='inv_senior_$dc"."_".$o."' value='$f_dat' ><br> ";
...
echo "<input type='hidden' name='total_guita' value='$total_final_final'>
	 ...
	 <input type='hidden' name='adulto_antes' value='$_POST[adulto_antes]'> 
<input type='hidden' name='bebe_antes' value='$_POST[bebe_antes]'> 
<input type='hidden' name='menor1_antes' value='$_POST[menor1_antes]'> 
<input type='hidden' name='menor2_antes' value='$_POST[menor2_antes]'> 
<input type='hidden' name='menor3_antes' value='$_POST[menor3_antes]'> 
<input type='hidden' name='senior_antes' value='$_POST[senior_antes]'> 
...
}else{ //if($vvender == "si"){ //ACA VA LA VENTA!!!!!!!!!!
