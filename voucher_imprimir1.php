...
echo "<div style='width:800px;border:1px solid #000;margin-bottom:5px;height:20px;font-size:12px'>
	...
	<div style='width:200px;float:left;height:20px;line-height:20px;border:1px solid #000'>
	 ...
	 <b>Tel�fonos de emergencia: <span style='font-size:14px'>$l_sql_em[tel2_empresa]</span>	 </div>
...
$busca_edpas = mysql_query("select * from edad_pasajeros where idd_carga_ep = '$_GET[id]'");
...
$ed_pas = $ed_pas."$l_ed_pas[tipo_pasajero_ep] $l_ed_pas[edad_ep] |";
...
if($c_sql_pas_tot > 0){
echo "Cantidad de pasajeros: ".$l_sql_pas_tot["num_pasaje_p"]."<span style='font-size:11px'>( Tipo/Edad $ed_pas )</span><br>"; 
}//if($c_sql_pas_tot > 0){
