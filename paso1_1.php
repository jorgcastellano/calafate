...
echo "<form method='post' action='paso2_1.php?id=$_GET[id]$clave_vendedor ' name='paso1'>";
...
$precio_total = $precio_total + $pprecio_finall;

//echo $lee_ar1["precio"]." - ".$pone_fecha1." ... ".date("d/m/Y",$pone_fecha1)."<br>";

echo "Precio de la habitacion del dia ".date("d/m/Y",$pone_fecha1)." : $$lee_ar1[precio] sin adicional <br>";
...
$ad[$i] = $lee_ad["precio_ad"] * $cantidad_dias;
