...
$calc_desc = ($lee_ar["precio"] * $descuento_vendedor) / 100;

$pprecio_finall = $lee_ar["precio"] - $calc_desc;

}else{//if($descuento_vendedor > 0){

$pprecio_finall = $lee_ar["precio"];
...
$precio_ar = $pprecio_finall + $suma_adicionales;
