...
echo "<script>location.href='articulo1.php?id=$_GET[id]&id_v=$_SESSION[id_usuario]'</script>";
...
echo "<div class='textos'>
      ...
      <b>CAPACIDAD: $lee1[capacidad] personas</b><br><br>
...
echo "<form method='post' action='paso1_1.php?id=$_GET[id]$clave_vendedor'>";
