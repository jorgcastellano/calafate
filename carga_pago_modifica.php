...
if($_POST["tipo_opereta"]=="mantener" && $_POST["es_distinto_dia"]=="no"){

mysql_query("DELETE from cantidad_billetes where idd_carga_cb='$_POST[id_carga]'");
mysql_query("DELETE from cantidad_billetes_vuelto where idd_carga_cb_v='$_POST[id_carga]'");
mysql_query("DELETE from ventas_pago where idd_venta_vp='$_POST[id_carga]'");

}//if($_POST["tipo_opereta"]=="mantener"){
...
mysql_query("INSERT INTO cantidad_billetes (moneda_cb,billete_cb,cantidad_cb,vendedor_cb,idd_carga_cb,fecha_cb) VALUES ('dolar','$billete','$cantidad','$_GET[id_v]','$_POST[id_carga]','$hoy_es')");
...
mysql_query("INSERT INTO cantidad_billetes (moneda_cb,billete_cb,cantidad_cb,vendedor_cb,idd_carga_cb,fecha_cb) VALUES ('euro','$billete','$cantidad','$_GET[id_v]','$_POST[id_carga]')");
...
mysql_query("INSERT INTO cantidad_billetes (moneda_cb,billete_cb,cantidad_cb,vendedor_cb,idd_carga_cb,fecha_cb) VALUES ('real','$billete','$cantidad','$_GET[id_v]','$_POST[id_carga]','$hoy_es')");
...
mysql_query("INSERT INTO cantidad_billetes (moneda_cb,billete_cb,cantidad_cb,vendedor_cb,idd_carga_cb,fecha_cb) VALUES ('peso chileno','$billete','$cantidad','$_GET[id_v]','$_POST[id_carga]','$hoy_es')");
...
mysql_query("INSERT INTO cantidad_billetes_vuelto (moneda_cb_v,billete_cb_v,cantidad_cb_v,vendedor_cb_v,idd_carga_cb_v,fecha_cb_v) VALUES ('dolar','$billete','$cantidad','$_GET[id_v]','$_POST[id_carga]','$hoy_es')");
...
mysql_query("INSERT INTO cantidad_billetes_vuelto (moneda_cb_v,billete_cb_v,cantidad_cb_v,vendedor_cb_v,idd_carga_cb_v,fecha_cb_v) VALUES ('euro','$billete','$cantidad','$_GET[id_v]','$_POST[id_carga]','$hoy_es')");
...
mysql_query("INSERT INTO cantidad_billetes_vuelto (moneda_cb_v,billete_cb_v,cantidad_cb_v,vendedor_cb_v,idd_carga_cb_v,fecha_cb_v) VALUES ('real','$billete','$cantidad','$_GET[id_v]','$_POST[id_carga]','$hoy_es')");
...
mysql_query("INSERT INTO cantidad_billetes_vuelto (moneda_cb_v,billete_cb_v,cantidad_cb_v,vendedor_cb_v,idd_carga_cb_v,fecha_cb_v) VALUES ('peso chileno','$billete','$cantidad','$_GET[id_v]','$_POST[id_carga]','$hoy_es')");
...
$estado_pago = "$_POST[tipo_opereta]";

if($_POST["tot_peso"] > 0){

mysql_query("INSERT INTO ventas_pago (idd_venta_vp,medio_pago_vp,moneda_vp,cotizacion_moneda_vp,num_cupon_vp,num_operacion_vp,importe_vp,vendedor_vp,fecha_vp,estado_vp) VALUES ('$_POST[id_carga]','efectivo','peso argentino','$_POST[cot_peso]','','','$_POST[tot_peso]','$_GET[id_v]','$hoy_dia','$estado_pago')");
...
mysql_query("INSERT INTO ventas_pago (idd_venta_vp,medio_pago_vp,moneda_vp,cotizacion_moneda_vp,num_cupon_vp,num_operacion_vp,importe_vp,vendedor_vp,fecha_vp,estado_vp) VALUES ('$_POST[id_carga]','credito','tarjeta de credito','1','$_POST[cupon_cred1]','$_POST[operacion_cred1]','$_POST[tot_credito1]','$_GET[id_v]','$hoy_dia','$estado_pago')");

} //if($_POST["tot_credito1s"] > 0){

if($_POST["tot_credito2"] > 0){

mysql_query("INSERT INTO ventas_pago (idd_venta_vp,medio_pago_vp,moneda_vp,cotizacion_moneda_vp,num_cupon_vp,num_operacion_vp,importe_vp,vendedor_vp,fecha_vp,estado_vp) VALUES ('$_POST[id_carga]','credito','tarjeta de credito','1','$_POST[cupon_cred2]','$_POST[operacion_cred2]','$_POST[tot_credito2]','$_GET[id_v]','$hoy_dia','$estado_pago')");
...
mysql_query("INSERT INTO ventas_pago (idd_venta_vp,medio_pago_vp,moneda_vp,cotizacion_moneda_vp,num_cupon_vp,num_operacion_vp,importe_vp,vendedor_vp,fecha_vp,estado_vp) VALUES ('$_POST[id_carga]','debito','tarjeta de debito','1','$_POST[cupon_deb1]','$_POST[operacion_deb1]','$_POST[tot_debito1]','$_GET[id_v]','$hoy_dia','$estado_pago')");

} //if($_POST["tot_debito1s"] > 0){

if($_POST["tot_debito2"] > 0){

mysql_query("INSERT INTO ventas_pago (idd_venta_vp,medio_pago_vp,moneda_vp,cotizacion_moneda_vp,num_cupon_vp,num_operacion_vp,importe_vp,vendedor_vp,fecha_vp,estado_vp) VALUES ('$_POST[id_carga]','debito','tarjeta de debito','1','$_POST[cupon_deb2]','$_POST[operacion_deb2]','$_POST[tot_debito2]','$_GET[id_v]','$hoy_dia','$estado_pago')");
...
mysql_query("INSERT INTO ventas_pago (idd_venta_vp,medio_pago_vp,moneda_vp,cotizacion_moneda_vp,num_cupon_vp,num_operacion_vp,importe_vp,vendedor_vp,fecha_vp,estado_vp) VALUES ('$_POST[id_carga]','efectivo','peso chileno','$_POST[cot_chileno]','','','$coti_mon','$_GET[id_v]','$hoy_dia','$estado_pago')");
...
mysql_query("INSERT INTO ventas_pago (idd_venta_vp,medio_pago_vp,moneda_vp,cotizacion_moneda_vp,num_cupon_vp,num_operacion_vp,importe_vp,vendedor_vp,fecha_vp,estado_vp) VALUES ('$_POST[id_carga]','efectivo','real','$_POST[cot_real]','','','$coti_mon','$_GET[id_v]','$hoy_dia','$estado_pago')");
...
mysql_query("INSERT INTO ventas_pago (idd_venta_vp,medio_pago_vp,moneda_vp,cotizacion_moneda_vp,num_cupon_vp,num_operacion_vp,importe_vp,vendedor_vp,fecha_vp,estado_vp) VALUES ('$_POST[id_carga]','efectivo','euro','$_POST[cot_euro]','','','$coti_mon','$_GET[id_v]','$hoy_dia','$estado_pago')");
...
mysql_query("INSERT INTO ventas_pago (idd_venta_vp,medio_pago_vp,moneda_vp,cotizacion_moneda_vp,num_cupon_vp,num_operacion_vp,importe_vp,vendedor_vp,fecha_vp,estado_vp) VALUES ('$_POST[id_carga]','efectivo','dolar','$_POST[cot_dolar]','','','$coti_mon','$_GET[id_v]','$hoy_dia','$estado_pago')");
...
echo "<form method='post' action='carga_pago_modifica.php?id_v=$_GET[id_v]' name='medio' style='margin-left:10px'>
...
####FIN ACTUALIZA ESTADO DE LA VENTA
####FIN ACTUALIZA ESTADO DE LA VENTA
####FIN ACTUALIZA ESTADO DE LA VENTA
