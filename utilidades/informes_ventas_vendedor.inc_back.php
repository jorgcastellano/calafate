...
$sql = mysql_query("select SUM(adulto_vs) as adulto_vs, SUM(bebe_vs) as bebe_vs, SUM(nino_vs) as nino_vs, SUM(nino1_vs) as nino1_vs, SUM(nino2_vs) as nino2_vs, SUM(senior_vs) as senior_vs,SUM(total_guita_vs) as total_guita_vs from ventas where idd_empresa_vs='$_SESSION[logeo]' $vendedor_sql and idd_sub2_vs='$l_ar[clave]' and estado_vs <> 'cancelado' and (idd_carga_vs >'$id_fecha' and idd_carga_vs <'$id_fecha1') ");



$l_sql = mysql_fetch_assoc($sql);

$suma_verifica = 0 + $l_sql["adulto_vs"]  + $l_sql["bebe_vs"]  + $l_sql["nino_vs"]  + $l_sql["nino1_vs"]  + $l_sql["nino2_vs"]  + $l_sql["senior_vs"]; 
...
$sql_tp = mysql_query("select SUM(importe_vp) as importe_vp from ventas_pago where $vendedor_sql1 medio_pago_vp='credito' $aptas_sql ");
...
$sql_tp = mysql_query("select SUM(importe_vp) as importe_vp from ventas_pago where $vendedor_sql1 medio_pago_vp='debito' $aptas_sql ");
...
$sql_tp = mysql_query("select SUM(importe_vp) as importe_vp from ventas_pago where $vendedor_sql1 moneda_vp='peso chileno' $aptas_sql ");
$lee_tp = mysql_fetch_assoc($sql_tp);

$sql_cot = mysql_query("select cotizacion_moneda_vp from ventas_pago where $vendedor_sql1 moneda_vp='peso chileno' and (idd_venta_vp >'$id_fecha' and idd_venta_vp <'$id_fecha1') limit 0,1 ");
...
$sql_tp = mysql_query("select SUM(importe_vp) as importe_vp from ventas_pago where $vendedor_sql1 moneda_vp='real' $aptas_sql ");
$lee_tp = mysql_fetch_assoc($sql_tp);

$sql_cot = mysql_query("select cotizacion_moneda_vp from ventas_pago where $vendedor_sql1 moneda_vp='real' and (idd_venta_vp >'$id_fecha' and idd_venta_vp <'$id_fecha1') limit 0,1 ");
$lee_cot = mysql_fetch_assoc($sql_cot);
...
$sql_tp = mysql_query("select SUM(importe_vp) as importe_vp from ventas_pago where $vendedor_sql1 moneda_vp='euro' $aptas_sql ");
$lee_tp = mysql_fetch_assoc($sql_tp);

$sql_cot = mysql_query("select cotizacion_moneda_vp from ventas_pago where $vendedor_sql1 moneda_vp='euro' and (idd_venta_vp >'$id_fecha' and idd_venta_vp <'$id_fecha1') limit 0,1 ");
$lee_cot = mysql_fetch_assoc($sql_cot);
...
$sql_tp = mysql_query("select SUM(importe_vp) as importe_vp from ventas_pago where $vendedor_sql1 moneda_vp='dolar' $aptas_sql ");
$lee_tp = mysql_fetch_assoc($sql_tp);

$sql_cot = mysql_query("select cotizacion_moneda_vp from ventas_pago where $vendedor_sql1 moneda_vp='dolar' and (idd_venta_vp >'$id_fecha' and idd_venta_vp <'$id_fecha1') limit 0,1 ");
$lee_cot = mysql_fetch_assoc($sql_cot);
