...
if(isset($_POST["escribano_carga_da1"])){

if($_POST["nombre"]!=""){

$b_check = mysql_query("select * from datos_adicionales where idd_empresa_da='$_SESSION[logeo]' and nombre_da='$_POST[nombre]' and tipo_da ='agencia' ");
...
mysql_query("INSERT INTO datos_adicionales (idd_empresa_da,nombre_da,tipo_da) VALUES ('$_SESSION[logeo]','$_POST[nombre]','agencia')");
...
echo "<script>document.getElementById('6').style.display='block'</script>";

}//cierra if escribano carga



if(isset($_POST["escribano_modifica_da1"])){
...
if(isset($_POST["escribano_borra_da1"])){
...
echo "<br><b>Agencias:</b><br><br>";

if(isset($_POST["escribano_modifica_da1"]) || isset($_POST["escribano_carga_da1"]) || isset($_POST["escribano_borra_da1"]) && $nop== "0"){
...
echo "<br><div style='width:180px;float:left;height:40px;border:1px solid #888888;padding:5px;margin-left:2px;margin-bottom:2px;line-height:40px'>
      ...
      <span style='font-size:14px;color:#555555'><b>Agregar agencia nueva:</b><span>
      </div>
      ...
      <input type='hidden' name='escribano_carga_da1' value='ok'>
...
$sql_ar = mysql_query("select * from datos_adicionales where idd_empresa_da = '$_SESSION[logeo]' and tipo_da='agencia' order by nombre_da asc");  
...
echo "<div style='width:180px;float:left;height:30px;border:1px solid #888888;padding:5px;margin-left:2px;margin-bottom:2px;line-height:30px'>
      ...
      <input type='hidden' name='escribano_modifica_da1' value='ok'>
      ...
      <form method='post' action='$_SERVER[PHP_SELF]'>
	  <input type='hidden' name='escribano_borra_da1' value='ok'>
	  <input type='hidden' name='id_da' value='$l_ar[id_da]'>	
