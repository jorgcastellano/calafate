...
<a href='informes_vendedor.php'><div style='background-image:url(imagenes/boton.png)' class='boton2' ><!-- fv -->
<div style='height:62px;margin-top:30px'> <img src='imagenes/caja.png' width=60 ></div>   

<div style='height:62px;margin-top:5px'><b>VER  <br> CAJA</b></div>
</div></a><!-- fv -->
