...
$precio_base = $l_sql["precio_base_vs"];
...
$tp_menores = $tp_menores + $l_sql["bebe_vs"];
...
}else{ //if($lee_tippas["tipo"]=="descuento"){



if($lee_tippas["bebe"]== $precio_base){

$tp_infoas = $tp_infoas + $l_sql["bebe_vs"];
}//if($lee_tippas["bebe"]==100){ 

if($lee_tippas["nino"]== $precio_base){
$tp_infoas = $tp_infoas + $l_sql["nino_vs"];
}//if($lee_tippas["bebe"]==100){ 

if($lee_tippas["nino1"]== $precio_base){
$tp_infoas = $tp_infoas + $l_sql["nino1_vs"];
}//if($lee_tippas["nino1"]==100){ 

if($lee_tippas["nino2"]== $precio_base){
$tp_infoas = $tp_infoas + $l_sql["nino2_vs"];
}//if($lee_tippas["nino2"]==100){ 

if($lee_tippas["senior"]== $precio_base){
$tp_infoas = $tp_infoas + $l_sql["senior_vs"];
}//if($lee_tippas["senior"]==100){ 



if($lee_tippas["bebe"]> 0.00 && $lee_tippas["bebe"]< $precio_base){
$tp_menores = $tp_menores + $l_sql["bebe_vs"];

}//if($lee_tippas["bebe"]==100){ 


if($lee_tippas["nino"]> 0.00 && $lee_tippas["nino"]< $precio_base){

$tp_menores = $tp_menores + $l_sql["nino_vs"];

}//if($lee_tippas["nino"]==100){ 

if($lee_tippas["nino1"]> 0.00 && $lee_tippas["nino1"]< $precio_base){
$tp_menores = $tp_menores + $l_sql["nino1_vs"];

}//if($lee_tippas["nino1"]==100){ 

if($lee_tippas["nino2"]> 0.00 && $lee_tippas["nino2"]< $precio_base){
$tp_menores = $tp_menores + $l_sql["nino2_vs"];
...
$adultos =  $tot_pasajeros - ($tp_infoas + $tp_menores);


$det_pasajeros = "Adultos: $adultos | Infoas: $tp_infoas | Menores: $tp_menores";
...
echo "<div style='width:60px;float:left;border:1px solid #555555;height:20px;margin-left:1px;text-align:center;line-height:20px'>Pick Up</div>
	  ...
	  <div style='width:620px;float:left;border:1px solid #555555;height:20px;margin-left:1px;text-align:center;line-height:20px'>Cantidad</div>
...
echo "<div style='width:60px;float:left;border:1px solid #555555;height:20px;margin-left:1px;line-height:20px;overflow:hidden'>
      &nbsp; $vvvalo[16]
...
//$adultos + $tp_infoas + $tp_menores	  
echo "<div style='width:614px;float:left;border:1px solid #555555;height:14px;margin-left:1px;line-height:13px;overflow:hidden;font-size:11px;padding:3px'>
     <span style='border:1px solid #555'><b> $tot_pasajeros </b> </span> &nbsp;&nbsp;&nbsp; | $ed_pas
...
/*	  
echo "<div style='width:200px;float:left;border:1px solid #555555;height:30px;margin-left:1px;line-height:15px;overflow:hidden;font-size:11px'>
      &nbsp; $texto_adic
...
echo "<div style='border:1px solid #555555;width:949px;height:20px;margin-left:1px;line-height:20px;overflow:hidden;font-size:11px;margin-bottom:1px'>
      &nbsp; <b>Adic.:</b> $texto_adic || <b>Obs:</b> $vvvalo[10]
...
echo "<div style='width:400px;float:left;border:1px solid #555555;height:20px;margin-left:330px;line-height:20px;overflow:hidden;font-size:11px'>
      &nbsp; <b> Tot.: &nbsp; $tot_pasajeros_suma Pax</b>
