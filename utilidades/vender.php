...
if($l_ar["clave_categoria_s2"]=="1" || $l_ar["clave_categoria_s2"]=="2" || $l_ar["clave_categoria_s2"]=="4" || $l_ar["clave_categoria_s2"]=="5"){
$linkq = "../articulo.php?id=$l_ar[clave]&id_v=$_SESSION[id_usuario]";
}//if($l_ar["clave_sub1_s2"]=="2"){


if($l_ar["clave_categoria_s2"]=="3"){
$linkq = "../articulo2.php?id=$l_ar[clave]&id_v=$_SESSION[id_usuario]";
}//if($l_ar["clave_sub1_s2"]=="2"){
...
echo "<div style='width:400px;float:left;height:40px;border:1px solid #888888;padding:5px;margin-left:2px;margin-bottom:2px'>
	  ...
	  <div style='width:120px;float:left;height:40px;border:1px solid #888888;padding:5px;margin-left:2px;margin-bottom:2px'>
      <input type='button' style='cursor:pointer;width:120px;height:40px;background-image:url(imagenes/bot_vender.png);border:0px' onclick=location.href='$linkq'>
