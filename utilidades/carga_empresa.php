...
$logo = "fotos_categorias/".$nombre_foto.".".$extension; 
   }else{
   $logo = "";
  }    
...
mysql_query("INSERT INTO usuario (idd_empresa_usuario,nombre_persona_usuario,nombre_usuario,contrasena_usuario,tipo_usuario,mail_usuario) VALUES ('$id_empresa','$_POST[nombre]','$_POST[nombre]','$_POST[pass1]','administrador','$_POST[mail]')");
...
<div style='color:#fff;font-size:25px;padding-top:150px;padding-left:50px'>REGISTRARSE </div>
</div>";
...
<input type="button" onclick="valida_empresa()" style="height:40px;width:120px;background-image:url(imagenes/bot_cargar.png);border:0px;margin-top:20px;margin-bottom:40px;cursor:pointer" value="">
</form>
