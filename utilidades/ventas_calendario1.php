...
echo "<a href='ventas.php?id_fecha=$fecha_ventz' style='color:#031A61;text-decoration:none' >".$x."</a>";
echo "</div>";

}else{//if($x == $dia){

echo "<div style='width:28px;float:left;text-align:center'>";
echo "<a href='ventas.php?id_fecha=$fecha_ventz' style='color:#cccccc;text-decoration:none' >".$x."</a>";
echo "</div>";
...
echo "<div class='fondo_boton' onclick=cambia_mes_venta('$mes1','$id_fecha') >";
echo $mes_d[$mes1];
echo "</div>";
...
echo "<div class='fondo_boton' onclick=cambia_mes_venta('$mes2','$id_fecha') >";
echo $mes_d[$mes2];
echo "</div>";
