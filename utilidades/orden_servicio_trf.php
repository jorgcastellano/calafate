...
echo "<div style='width:120px;float:left;border:1px solid #555555;height:20px;margin-left:1px;text-align:center;line-height:20px'>Pick Up</div>
	  ...
	  <div style='width:120px;float:left;border:1px solid #555555;height:20px;margin-left:1px;text-align:center;line-height:20px'>Vuelo In</div>
	  
	  <div style='width:120px;float:left;border:1px solid #555555;height:20px;margin-left:1px;text-align:center;line-height:20px'>Vehiculo</div>
