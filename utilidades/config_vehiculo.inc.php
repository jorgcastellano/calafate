...
if(isset($_POST["escribano_carga_da2"])){

if($_POST["nombre"]!=""){

$b_check = mysql_query("select * from datos_adicionales where idd_empresa_da='$_SESSION[logeo]' and nombre_da='$_POST[nombre]' and tipo_da ='vehiculo' ");
...
mysql_query("INSERT INTO datos_adicionales (idd_empresa_da,nombre_da,tipo_da) VALUES ('$_SESSION[logeo]','$_POST[nombre]','vehiculo')");
...
if(isset($_POST["escribano_modifica_da2"])){
...
if(isset($_POST["escribano_borra_da2"])){
...
echo "<br><b>vehiculos:</b><br><br>";


if(isset($_POST["escribano_modifica_da2"]) || isset($_POST["escribano_carga_da2"]) || isset($_POST["escribano_borra_da2"])){
...
echo "<br><div style='width:180px;float:left;height:40px;border:1px solid #888888;padding:5px;margin-left:2px;margin-bottom:2px;line-height:40px'>
      ...
      <span style='font-size:14px;color:#555555'><b>Agregar vehiculo nuevo:</b><span>
      </div>
      ...
      <input type='hidden' name='escribano_carga_da2' value='ok'>
...
$sql_ar = mysql_query("select * from datos_adicionales where idd_empresa_da = '$_SESSION[logeo]' and tipo_da='vehiculo' order by nombre_da asc");  
...
echo "<div style='width:180px;float:left;height:30px;border:1px solid #888888;padding:5px;margin-left:2px;margin-bottom:2px;line-height:30px'>
      ...
      <input type='hidden' name='escribano_modifica_da2' value='ok'>
      ...
      <form method='post' action='$_SERVER[PHP_SELF]'>
	  <input type='hidden' name='escribano_borra_da2' value='ok'>
	  <input type='hidden' name='id_da' value='$l_ar[id_da]'>	
