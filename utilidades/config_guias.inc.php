...
$b_check = mysql_query("select * from datos_adicionales where idd_empresa_da='$_SESSION[logeo]' and nombre_da='$_POST[nombre]' and tipo_da ='guias' ");
...
mysql_query("INSERT INTO datos_adicionales (idd_empresa_da,nombre_da,tipo_da) VALUES ('$_SESSION[logeo]','$_POST[nombre]','guias')");
...
if(isset($_POST["escribano_modifica_da"])){
...
if(isset($_POST["escribano_borra_da"])){
...
if(isset($_POST["escribano_modifica_da"]) || isset($_POST["escribano_carga_da"]) || isset($_POST["escribano_borra_da"]) ){
...
$sql_ar = mysql_query("select * from datos_adicionales where idd_empresa_da = '$_SESSION[logeo]' and tipo_da='guias' order by nombre_da asc");  
...
echo "<div style='width:180px;float:left;height:30px;border:1px solid #888888;padding:5px;margin-left:2px;margin-bottom:2px;line-height:30px'>
      ...
      <input type='hidden' name='escribano_modifica_da' value='ok'>
      ...
      <form method='post' action='$_SERVER[PHP_SELF]'>
	  <input type='hidden' name='escribano_borra_da' value='ok'>
	  <input type='hidden' name='id_da' value='$l_ar[id_da]'>	
