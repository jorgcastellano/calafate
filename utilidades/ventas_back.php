...
<body>
         ...
         <div style="background-color:#ffffff;width:2600px" > <!-- EEEEE -->
...
$busca_total = mysql_query("select * from ventas where idd_empresa_vs='$_SESSION[logeo]' and (idd_carga_vs >'$id_fecha' and idd_carga_vs <'$id_fecha1') order by id_ventas desc");
$cta_total = mysql_num_rows($busca_total);
  //fin busco la cantidad


$sql = mysql_query("select * from ventas where idd_empresa_vs='$_SESSION[logeo]' and (idd_carga_vs >'$id_fecha' and idd_carga_vs <'$id_fecha1') order by id_ventas desc limit 0,10");
...
if(isset($_GET["pagineo0"])!=""){
				   ...
				   for($e=1;$e<550;$e++){
					...
					$sql = mysql_query("select * from ventas where idd_empresa_vs='$_SESSION[logeo]' and (idd_carga_vs >'$id_fecha' and idd_carga_vs <'$id_fecha1') order by id_ventas desc limit $arra_conteo[$num_page],10");
...
echo "<div style='border:1px solid #cccccc;height:30px;line-height:30px;font-size:10px;margin-bottom:2px;width:2600px'>
      ...
      <div style='width:120px;float:left'><b>Ult. modif</b> </div>
      <div style='width:120px;float:left'><b>Fecha modif </b> </div>
	  
	  
	  
	  
	  <div style='width:100px;float:left;color:#0061cc'><b>Vehiculo </b> </div>
	  <div style='width:100px;float:left;color:#0061cc'><b>Hotel </b> </div>
	  <div style='width:100px;float:left;color:#0061cc'><b>Agencia </b> </div>
	  ...
	  <div style='width:100px;float:left;color:#0061cc'><b>Chofer </b> </div>
	  <div style='width:100px;float:left;color:#0061cc'><b>Guia </b> </div>
...
echo "<div style='border:1px solid #cccccc;width:2600px;height:30px;line-height:30px;font-size:10px;margin-bottom:2px'>
      ...
      <div style='width:100px;float:left;overflow:hidden'>$l_sql[estado_vs]</div>
      <div style='width:200px;float:left;overflow:hidden'>$nombre_comprador </div>
      <div style='width:100px;float:left;overflow:hidden'>$vendedor </div>
	  <div style='width:60px;float:left;overflow:hidden;text-align:center'>% $l_sql[comision_vs]</div>";
	  
$fech_ult = date("d/m/y | G.i<br>", $l_sql["fecha_ult_modificacion_vs"]);	  
	  
	  
echo "<div style='width:120px;float:left;overflow:hidden;height:30px'>  $l_sql[ult_modificacion_vs]</div>
	  <div style='width:120px;float:left;overflow:hidden;height:30px'>  $fech_ult Hs</div>
	   </a>
	   
	   	  <div style='width:100px;float:left;height:30px'>$l_vi[vehiculo_vi] </div>
	  ...
	  <div style='width:100px;float:left;height:30px'>$l_vi[guia_vi] </div>
	  ...
	  <div style='width:115px;float:left'><a href='ventas_modifica.php?id=$l_sql[id_ventas]'><img src='imagenes/bot_modificar1.png' style='margin-top:3px'></a></div>
