...
echo "<div style='width:800px;border:1px solid #000;margin-bottom:5px;height:20px;font-size:12px'>
	...
	<div style='width:200px;float:left;height:20px;line-height:20px;border:1px solid #000'>
	 ...
	 <b>Tel�fonos de asistencia en viaje: <span style='font-size:14px'>$l_sql_em[tel2_empresa]</span>	 </div>
...
$text_comprador = $text_comprador."$l_pas[campo1_p] : $l_pas[campo2_p] | ";	  
...
?>
 ...
 <div style="width:800px;margin:0px auto;font-family:arial;font-size:12px">													 


<div style="text-align:center">
<!--<a href="javascript:imprSelec('seleccion')" ><img src="imagenes/imprimir.jpg" ></a>-->

<?php
echo "<a href='voucher_imprimir1.php?id=$_GET[id]' ><img src='imagenes/imprimir.jpg' ></a>";
?>
